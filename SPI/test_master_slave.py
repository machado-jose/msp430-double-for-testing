...
class Test_Template(unittest.TestCase):
	...
	def test_reading_registers_without_indicating_address(self):
		...
		# 3 - Results gathering
		gotten_readings = self.dut_serial.repl("master.read_registers_wo_address(4)",0.6)[2]
	...
	def test_reading_registers_indicating_address(self):
		...
		# 3 - Results gathering
		gotten_readings = self.dut_serial.repl("master.read_registers_w_address(14,4)",0.6)[2]
		gotten_readings = gotten_readings.decode()
	...
	def test_writing_registers_without_indicating_address(self):
		...
		self.dut_serial.repl("master.write_registers_wo_address([1,2,3])",1)
		# 3 - Results gathering
	...
	def test_writing_registers_indicating_address(self):
		...
		self.dut_serial.repl("master.write_registers_w_address(14, [1,2,3])",0.6)
		# 3 - Results gathering
	...
	#closes serial 
	def tearDown(self):
		self.dut_serial.repl("master.deinit(); del master; del Dut_master;", 0.4)
